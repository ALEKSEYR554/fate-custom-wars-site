class RandomServantsController < ApplicationController
  def serve
    safe_filename = File.basename(params[:filename])
    file_path = Rails.root.join("storage", "random_servants", safe_filename)
    ...
    if File.exist?(file_path)
      ...
      if safe_filename == "index.html"
        ...
        redirect_to "/random_servants/index.html"
      end
    end
  end
end
