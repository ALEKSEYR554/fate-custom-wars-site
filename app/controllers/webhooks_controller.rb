class WebhooksController < ApplicationController
  ...
  def gitea
    ...
    Thread.new do
      sleep 2
      system("cd /home/fate-custom-wars-site-rails && git pull && RAILS_ENV=production /root/.local/share/mise/shims/bundle exec rails db:migrate && systemctl restart fate-puma")
    end
