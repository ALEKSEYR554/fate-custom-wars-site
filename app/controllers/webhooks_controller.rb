class WebhooksController < ApplicationController
  ...
  def gitea
    ...
    Thread.new do
      sleep 2
      system("(cd /home/fate-custom-wars-site-rails && git fetch --all && git reset --hard origin/main && RAILS_ENV=production /root/.local/share/mise/shims/bundle install && RAILS_ENV=production /root/.local/share/mise/shims/bundle exec rails db:migrate && systemctl restart fate-puma) > log/update.log 2>&1")
    end
